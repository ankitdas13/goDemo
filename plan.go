...
func (r *PlanService) Get(ctx context.Context, id string, opts ...option.RequestOption) (res *Plan, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
// ToParam converts this PlanItem to a PlanItemParam.
//
...
func (r PlanItemParam) MarshalJSON() (data []byte, err error) {
	type shadow PlanItemParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *PlanItemParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type PlanNewParams struct {
	...
	Item     PlanItemParam `json:"item,omitzero,required"`
