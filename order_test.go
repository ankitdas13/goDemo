...
func TestOrderNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Orders.New(context.TODO(), godemo.OrderNewParams{
		Amount:                1000,
		Currency:              "INR",
		FirstPaymentMinAmount: godemo.Int(0),
		...
		OfferID:        godemo.String("offer_JHD834hjbxzhd38d"),
		PartialPayment: godemo.Bool(true),
		Receipt:        godemo.String("rcptid_11"),
	})
	if err != nil {
...
func TestOrderListPaymentsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Orders.ListPayments(
		context.TODO(),
		"id",
		godemo.OrderListPaymentsParams{
			Expand: godemo.OrderListPaymentsParamsExpandCard,
		},
	)
	if err != nil {
		var apierr *godemo.Error
