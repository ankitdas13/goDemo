...
// interacting with the godemo API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (GODEMO_USERNAME,
// GODEMO_PASSWORD, GODEMO_BASE_URL). This should be used to initialize new
// clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("GODEMO_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("GODEMO_USERNAME"); ok {
		defaults = append(defaults, option.WithUsername(o))
	}
	if o, ok := os.LookupEnv("GODEMO_PASSWORD"); ok {
...
// environment (GODEMO_USERNAME, GODEMO_PASSWORD, GODEMO_BASE_URL). The option
